...
class BotPlayer:
    """Optimized dual-bot strategy with proper coordination"""
    
    def __init__(self, map_copy):
        self.map = map_copy
        
        # Dedicated resources per bot for parallel work
        self.counter1_loc = None  # Bot1's meat processing counter
        self.counter2_loc = None  # Bot2's plate assembly counter
        self.cooker1_loc = None   # Primary cooker
        self.cooker2_loc = None   # Secondary cooker
        self.shop_loc = None
        self.submit_loc = None
        self.trash_loc = None
        
        # Bot states
        self.bot1_state = "init"  # Cook: init -> buy_pan -> cooking_loop
        self.bot2_state = "init"  # Assembler: init -> wait_for_meat -> assembly_loop
        
        # Shared state
        self.pan_ready = False
        self.bot1_active_cooker = None  # Track which cooker Bot1 is using
        self.meat_stockpile = 0  # Count of cooked meats on counter1
